...
fn bench_mnist1(c: &mut Criterion) {
    let (engine, inputs) = load_single_input(&fixture("mnist-1"), "model.onnx");
...
fn bench_mnist7(c: &mut Criterion) {
    let (engine, inputs) = load_single_input(&fixture("mnist-7"), "model.onnx");
...
fn bench_mnist8(c: &mut Criterion) {
    let (engine, inputs) = load_single_input(&fixture("mnist-8"), "model.onnx");
...
fn bench_mnist12(c: &mut Criterion) {
    let (engine, inputs) = load_single_input(&fixture("mnist-12"), "mnist-12.onnx");
...
fn bench_mobilenetv2_7(c: &mut Criterion) {
    let (engine, inputs) = load_single_input(&fixture("mobilenetv2-7"), "mobilenetv2-7.onnx");
...
fn bench_mobilenetv2_12(c: &mut Criterion) {
    let (engine, inputs) = load_single_input(&fixture("mobilenetv2-12"), "mobilenetv2-12.onnx");
...
fn bench_tinyyolov2_7(c: &mut Criterion) {
    let (engine, inputs) = load_single_input(&fixture("tinyyolov2-7"), "model.onnx");
...
fn bench_tinyyolov3_11(c: &mut Criterion) {
    let (engine, inputs) = load_multi_input(&fixture("tiny-yolov3-11"), "yolov3-tiny.onnx");
